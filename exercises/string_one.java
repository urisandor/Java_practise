...
class string_one {
    ...
    static String bothEnds(String s) {
        ...
        result = s.substring(0,2) + s.substring(s.length()-2, s.length());
        return result;
    }
    ...
    static String fixStart(String s)
    {
        ...
        s = s.substring(1, s.length()).replace(elso, '*');
        return  elso + s;
    }
    ...
    {
        String a_start = a.substring(0, 2) + b.substring(2, b.length());
        String b_start = b.substring(0, 2) + a.substring(2, a.length()); 
